import datetime
import pika
from src.inmemclient.inmemclient.connection import Connection
...
import src.inmemclient.inmemclient.settings as settings
...
class MqLogging():
    ...
    def __init__(self):
        ...
        self._rmqconnection = Connection('rmqlogger')
