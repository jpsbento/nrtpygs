...
class RmqConnection():
    ...
    def connect(self):
        ...
        time.sleep(settings.CONNECTION_WAITIME/1000)
    ...
    def create_channel(self, channel_number=None):
        """
        Create a cahnnel on the connection. Once open return the channel object
        """

        self.new_channel = self._connection.channel(on_open_callback=self.on_channel_open)
